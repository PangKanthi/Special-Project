...
const Profile = () => {
  ...
  return (
    <div className="flex flex-column lg:flex-row p-4">
      <aside
        className="lg:w-1/5 bg-blue-600 text-white p-4 border-round-lg shadow-2"
            ...
            {sidebarItems.map((item, index) => (
              <li
                ...
                className={classNames(
                  "p-3 cursor-pointer flex align-items-center justify-content-between hover:bg-blue-500 border-round",
                  { "bg-blue-400": selectedMenu === item.label }
                )}
      ...
      <main
        className="flex-1 bg-white border-round-lg p-5 shadow-2 ml-0 lg:ml-3 mt-4 lg:mt-0"
        style={{ height: "900px" }}
      >
        <div>
          <h2>{selectedMenu}</h2>
      ...
      <div className="flex">
        ...
        <Dialog
          ...
          style={{ width: "400px", borderRadius: "12px" }} // กำหนดขนาด Dialog
          modal
        >
          <Panel header="กรุณากรอกรหัสผ่าน" style={{ borderRadius: "12px" }}>
