...
const AddressPage = () => {
    ...
    try {
      if (isEditing && newAddress.id) {
        ...
        const response = await fetch(
          `https://api.d-dayengineering.com/api/addresses/${newAddress.id}`,
          {
            method: "PUT",
            headers: {
        ...
        const response = await fetch("https://api.d-dayengineering.com/api/addresses", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://api.d-dayengineering.com/api/addresses/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
